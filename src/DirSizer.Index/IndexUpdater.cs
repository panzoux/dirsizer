...
// change twice is therefore harmless. Every entry replaced or removed is added to dirty, which decides what the next
// delta file holds.
static class IndexUpdater
{
    ...
    public static UpdateResult Apply(Dictionary<ulong, FileRecord> records, List<UsnChange> changes, SortedSet<ulong> alwaysReread, IRecordSource source, SortedSet<ulong>? dirty = null)
    {
